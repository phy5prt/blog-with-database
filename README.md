# blog-with-database
simple blog site enabling creation of articles all with their own route and composition with compose route

This webapp allows you to compose a blog post, 
the title and first bit of text appears on the main page with a link to the whole blog article with the title as the route.
